<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="category-grid-2.aspx.cs" Inherits="category_grid_2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
    <div class="container">
            ...
            <asp:Repeater ID="Repeater1" runat="server">
                           ...
                           <div class="col-xs-12 col-sm-4 no-margin product-item-holder hover">
                                                <div class="product-item">
                                                    ...
                                                    <div class="body">
                                                        ...
                                                        <div class="title">
                                                            <a href="single-product.aspx"> <%# DataBinder.Eval(Container.DataItem, "Name") %></a>
                                                        </div>
                                                        <div class="brand"><%# DataBinder.Eval(Container.DataItem, "Supplier") %></div>
                                                    </div>
                                                    <div class="prices">
                                                        <div class="price-prev">   <%# DataBinder.Eval(Container.DataItem, "Price", "{0:c}") %></div>
                                                        <div class="price-current pull-right"> <%# DataBinder.Eval(Container.DataItem, "Price", "{0:c}") %></div>
                                                    </div>
                                                    <div class="hover-area">
                                                        <div class="add-cart-button">

                                                            <a href="single-product.aspx?id=<%#Eval("ProductID")%>" class="le-button">add to cart</a>
                                                        </div>
                   ...
                   <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:eczaneConnectionString2 %>" SelectCommand="SELECT * FROM [eczaneBilgi]"></asp:SqlDataSource>
                                            <div class="col-xs-12 col-sm-4 no-margin product-item-holder hover">
                                                <div class="product-item">
                                                    <div class="ribbon red"><span>sale</span></div>
                                                    <div class="image">
                                            ...
                                            <div class="col-xs-12 col-sm-4 no-margin product-item-holder hover">
                                                <div class="product-item">
                                                    ...
                                                    <div class="body">
                                                        <div class="label-discount clear"></div>
                                                        <div class="title">
                                                            <a href="single-product.aspx">Netbook Acer TravelMate B113-E-10072</a>
                                                        </div>
