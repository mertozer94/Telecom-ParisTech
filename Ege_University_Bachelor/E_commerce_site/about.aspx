                        ...
                        <section id="our-team">
                            ...
                            <ul class="team-members list-unstyled">
                                ...
                                <li class="team-member">
                                    ...
                                    <div class="profile">
                                        <h3>Mert ÖZER <small class="designation">CEO/Founder</small></h3>
                                ...
                                <li class="team-member">
                                    ...
                                    <div class="profile">
                                        <h3>Ali Fırat ÜNVER&nbsp; <small class="designation">Support Staff</small></h3>
                                        <ul class="social list-unstyled">
                                            <li>
                                                <a href="http://facebook.com/">
                                                    <span class="fa-stack fa-lg">
            ...
            <div class="container">
                <div class="row no-margin widgets-row">
                            ...
                            <div class="body">
                                <ul>
                                    <li>
                                        <div class="row">
                                            <div class="col-xs-12 col-sm-9 no-margin">
                                                <a href="single-product.aspx">Netbook Acer Travel B113-E-10072</a>
                                                <div class="price">
                                    ...
                                    <li>
                                        <div class="row">
                                            <div class="col-xs-12 col-sm-9 no-margin">
                                                <a href="single-product.aspx">PowerShot Elph 115 16MP Digital Camera</a>
                                                <div class="price">
                                                    <div class="price-prev">$2000</div>
                                                    <div class="price-current">$1873</div>
                                                </div>
                            ...
                            <div class="body">
                                <ul>
                                    <li>
                                        <div class="row">
                                            <div class="col-xs-12 col-sm-9 no-margin">
                                                <a href="single-product.aspx">HP Scanner 2910P</a>
                                                <div class="price">
                                                    <div class="price-prev">$2000</div>
                                                    <div class="price-current">$1873</div>
                                                </div>
                                    ...
                                    <li>
                                        <div class="row">
                                            <div class="col-xs-12 col-sm-9 no-margin">
                                                <a href="single-product.aspx">Galaxy Tab 3 GT-P5210 16GB, Wi-Fi, 10.1in - White</a>
                                                <div class="price">
                                                    <div class="price-prev">$2000</div>
                                                    <div class="price-current">$1873</div>
                                                </div>
                    ...
                    <div class="col-xs-12 col-sm-4 ">
                        <!-- ============================================================= TOP RATED PRODUCTS ============================================================= -->
                        <div class="widget">
                            <h2>En Beğenilen Ürünler</h2>
                            <div class="body">
                                <ul>
                                    <li>
                                        <div class="row">
                                            <div class="col-xs-12 col-sm-9 no-margin">
                                                <a href="single-product.aspx">Galaxy Tab GT-P5210, 10" 16GB Wi-Fi</a>
                                                <div class="price">
                                                    <div class="price-prev">$2000</div>
                                                    <div class="price-current">$1873</div>
                                                </div>
                                    ...
                                    <li>
                                        <div class="row">
                                            <div class="col-xs-12 col-sm-9 no-margin">
                                                <a href="single-product.aspx">Surface RT 64GB, Wi-Fi, 10.6in - Dark Titanium</a>
                                                <div class="price">
                                                    <div class="price-prev">$2000</div>
                                                    <div class="price-current">$1873</div>
                                                </div>
                    ...
                    <div class="col-xs-12 col-md-8 no-margin">
                        ...
                        <div class="link-widget">
                            <div class="widget">
                                <h3>Find it fast</h3>
                                <ul>
                                    <li><a href="category-grid.aspx">laptops &amp; computers</a></li>
                                    <li><a href="category-grid.aspx">Cameras &amp; Photography</a></li>
                                    <li><a href="category-grid.aspx">Smart Phones &amp; Tablets</a></li>
                                    <li><a href="category-grid.aspx">Video Games &amp; Consoles</a></li>
                                    <li><a href="category-grid.aspx">TV &amp; Audio</a></li>
                                    <li><a href="category-grid.aspx">Gadgets</a></li>
                                    <li><a href="category-grid.aspx">Car Electronic &amp; GPS</a></li>
                                    <li><a href="category-grid.aspx">Accesories</a></li>
                                </ul>
                            </div><!-- /.widget -->
                        </div><!-- /.link-widget -->
                        <div class="link-widget">
                            <div class="widget">
                                <h3>Information</h3>
                                <ul>
                                    <li><a href="category-grid.aspx">Find a Store</a></li>
                                    <li><a href="category-grid.aspx">About Us</a></li>
                                    <li><a href="category-grid.aspx">Contact Us</a></li>
                                    <li><a href="category-grid.aspx">Weekly Deals</a></li>
                                    <li><a href="category-grid.aspx">Gift Cards</a></li>
                                    <li><a href="category-grid.aspx">Recycling Program</a></li>
                                    <li><a href="category-grid.aspx">Community</a></li>
                                    <li><a href="category-grid.aspx">Careers</a></li>
                                </ul>
                            </div><!-- /.widget -->
                        </div><!-- /.link-widget -->
                        <div class="link-widget">
                            <div class="widget">
                                <h3>Information</h3>
                                <ul>
                                    <li><a href="category-grid.aspx">My Account</a></li>
                                    <li><a href="category-grid.aspx">Order Tracking</a></li>
                                    <li><a href="category-grid.aspx">Wish List</a></li>
                                    <li><a href="category-grid.aspx">Customer Service</a></li>
                                    <li><a href="category-grid.aspx">Returns / Exchange</a></li>
                                    <li><a href="category-grid.aspx">FAQs</a></li>
                                    <li><a href="category-grid.aspx">Product Support</a></li>
                                    <li><a href="category-grid.aspx">Extended Service Plans</a></li>
                                </ul>
                            </div><!-- /.widget -->
                        </div><!-- /.link-widget -->
                        <!-- ============================================================= LINKS FOOTER : END ============================================================= -->
            ...
            <div class="copyright-bar">
                <div class="container">
                    <div class="col-xs-12 col-sm-6 no-margin">
                        <div class="copyright">
                            &copy; <a href="index.aspx">Media Center</a> - all rights reserved
                        </div><!-- /.copyright -->
                    </div>
                    <div class="col-xs-12 col-sm-6 no-margin">
