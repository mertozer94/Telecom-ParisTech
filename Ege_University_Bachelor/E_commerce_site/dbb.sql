...
/****** Object:  Database [eczane]    Script Date: 30.05.2016 19:34:39 ******/
CREATE DATABASE [eczane]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'eczane', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL12.SQLEXPRESS\MSSQL\DATA\eczane.mdf' , SIZE = 5120KB , MAXSIZE = UNLIMITED, FILEGROWTH = 1024KB )
 LOG ON 
( NAME = N'eczane_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL12.SQLEXPRESS\MSSQL\DATA\eczane_log.ldf' , SIZE = 2048KB , MAXSIZE = 2048GB , FILEGROWTH = 10%)
GO

ALTER DATABASE [eczane] SET COMPATIBILITY_LEVEL = 120
GO
