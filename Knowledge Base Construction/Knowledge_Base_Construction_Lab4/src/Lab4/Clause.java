...
public class Clause {
    ...
    public static void main(String[] args) {
        System.out.println(new Clause("a  , b, c 12.10"));
        System.out.println(new Clause("a 12.10"));
        System.out.println(new Clause("a,b 12.10"));
        System.out.println(new Clause("a => b 12.10"));
        System.out.println(new Clause("=> b 12.10"));
        System.out.println(new Clause("a&b&c=> d 12.10"));
    }
}
